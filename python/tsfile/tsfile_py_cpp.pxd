...
cdef public api ResultSet tsfile_reader_query_paths_c(TsFileReader reader, object device_name, object sensor_list,
                                                      int64_t start_time,
                                                      int64_t end_time)
...
cdef public api ResultSet tsfile_reader_query_table_by_row_c(TsFileReader reader, object table_name,
                                                             ...
                                                             int limit,TagFilterHandle tag_filter, int batch_size)
