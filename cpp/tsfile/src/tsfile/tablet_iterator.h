...
public:
  ...
  int get_next(int64_t &timestamp, bool &value) { GET_TYPED_NEXT(timestamp, bool, BOOLEAN, value); }
  int get_next(int64_t &timestamp, int32_t &value) { GET_TYPED_NEXT(timestamp, int32_t, INT32, value); }
  int get_next(int64_t &timestamp, int64_t &value) { GET_TYPED_NEXT(timestamp, int64_t, INT64, value); }
  int get_next(int64_t &timestamp, float &value) { GET_TYPED_NEXT(timestamp, float, FLOAT, value); }
  int get_next(int64_t &timestamp, double &value) { GET_TYPED_NEXT(timestamp, double, DOUBLE, value); }
