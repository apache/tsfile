...
#ifndef STORAGE_TSFILE_STATISTIC_H
#define STORAGE_TSFILE_STATISTIC_H
...
public:
  ...
  virtual FORCE_INLINE void update(int64_t time, bool    value) { ASSERT(false); }
  virtual FORCE_INLINE void update(int64_t time, int32_t value) { ASSERT(false); }
  virtual FORCE_INLINE void update(int64_t time, int64_t value) { ASSERT(false); }
  virtual FORCE_INLINE void update(int64_t time, float   value) { ASSERT(false); }
  virtual FORCE_INLINE void update(int64_t time, double  value) { ASSERT(false); }

  virtual int serialize_to(common::ByteStream &out)
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::write_var_uint(count_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(start_time_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(end_time_, out))) {
    } else if (RET_FAIL(serialize_typed_stat(out))) {
    }
    return ret;
  }
  virtual int serialize_typed_stat(common::ByteStream &out) { ASSERT(false); return 0; }
  virtual int deserialize_from(common::ByteStream &in)
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::read_var_uint((uint32_t&)count_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)start_time_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)end_time_, in))) {
    } else if (RET_FAIL(deserialize_typed_stat(in))) {
    }
    return ret;
  }
  virtual int deserialize_typed_stat(common::ByteStream &in) { ASSERT(false); return 0; }
  virtual int merge_with(Statistic *that) { ASSERT(false); return 0; }
  virtual int deep_copy_from(Statistic *stat) { ASSERT(false); return 0; }
  virtual common::TSDataType get_type() { ASSERT(false); return common::INVALID_DATATYPE; }
  virtual std::string to_string() const { return std::string("UNTYPED_STATISTIC"); }
...
public:
  ...
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::write_ui8(first_value_ ? 1 : 0, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui8(last_value_ ? 1 : 0, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(sum_value_, out))) {
    }
    return ret;
  }
  ...
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::read_ui8((uint8_t&)first_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui8((uint8_t&)last_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)sum_value_, in))) {
    }
    return ret;
  }
...
public:
  ...
  int serialize_typed_stat(common::ByteStream &out)
  {
    ...
    } else if (RET_FAIL(common::SerializationUtil::write_ui32(max_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui32(first_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui32(last_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(sum_value_, out))) {
    }
    return ret;
  }
  ...
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::read_ui32((uint32_t&)min_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui32((uint32_t&)max_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui32((uint32_t&)first_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui32((uint32_t&)last_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)sum_value_, in))) {
    }
  ...
  std::string to_string() const
  {
    ...
    snprintf(buf, buf_len,
            "{count=%d, start_time=%" PRId64 ", end_time=%" PRId64 ", first_val=%d, last_val=%d, sum_value=%" PRId64 ", min_value=%d, max_value=%d}",
            count_, start_time_, end_time_, first_value_,
            last_value_, sum_value_, min_value_, max_value_);
...
public:
  ...
  int serialize_typed_stat(common::ByteStream &out)
  {
    ...
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(max_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(first_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_ui64(last_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(sum_value_, out))) {
    }
    return ret;
  }
  int deserialize_typed_stat(common::ByteStream &in)
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)min_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)max_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)first_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_ui64((uint64_t&)last_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_double(sum_value_, in))) {
    }
    return ret;
  }
  int merge_with(Statistic *stat)
  ...
  std::string to_string() const
  {
    ...
    char buf[buf_len];
    snprintf(buf, buf_len,
            "{count=%d, start_time=%" PRId64 ", end_time=%" PRId64 ", first_val=%" PRId64 ", last_val=%" PRId64 ", sum_value=%lf, min_value=%" PRId64 ", max_value=%" PRId64 "}",
            count_, start_time_, end_time_, first_value_,
            last_value_, sum_value_, min_value_, max_value_);
    return std::string(buf);
  }
...
public:
  ...
  int serialize_typed_stat(common::ByteStream &out)
  {
    ...
    } else if (RET_FAIL(common::SerializationUtil::write_float(max_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_float(first_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_float(last_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(sum_value_, out))) {
    }
    return ret;
  }
  int deserialize_typed_stat(common::ByteStream &in)
  {
    ...
    } else if (RET_FAIL(common::SerializationUtil::read_float(max_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_float(first_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_float(last_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_double(sum_value_, in))) {
    }
    return ret;
  }
...
public:
  ...
  {
    int ret = common::E_OK;
    if (RET_FAIL(common::SerializationUtil::write_double(min_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(max_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(first_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(last_value_, out))) {
    } else if (RET_FAIL(common::SerializationUtil::write_double(sum_value_, out))) {
    }
    return ret;
  }
  int deserialize_typed_stat(common::ByteStream &in)
  {
    ...
    } else if (RET_FAIL(common::SerializationUtil::read_double(max_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_double(first_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_double(last_value_, in))) {
    } else if (RET_FAIL(common::SerializationUtil::read_double(sum_value_, in))) {
    }
    return ret;
  }
...
FORCE_INLINE Statistic* placement_new_statistic(common::TSDataType type, void *buf)
{
  Statistic *s = nullptr;
  switch (type) {
    case common::BOOLEAN:
...
#define TYPED_CLONE_STATISTIC(StatType)  (static_cast<StatType*>(to))->clone_from(*(static_cast<const StatType*>(from)))

FORCE_INLINE void clone_statistic(Statistic *from, Statistic *to, common::TSDataType type)
{
  ASSERT(from != nullptr);
  ASSERT(to != nullptr);
...
#endif // STORAGE_TSFILE_STATISTIC_H
