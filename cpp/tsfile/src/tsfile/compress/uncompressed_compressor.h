...
#ifndef STORAGE_TSFILE_COMPRESS_UNCOMPRESSED_COMPRESSOR_H
#define STORAGE_TSFILE_COMPRESS_UNCOMPRESSED_COMPRESSOR_H
...
#endif // STORAGE_TSFILE_COMPRESS_UNCOMPRESSED_COMPRESSOR_H
