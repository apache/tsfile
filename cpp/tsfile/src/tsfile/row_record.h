#ifndef STORAGE_TSFILE_READ_COMMON_ROW_RECORD_H
#define STORAGE_TSFILE_READ_COMMON_ROW_RECORD_H
...
struct Field
{
  ...
  FORCE_INLINE bool is_literal() const
  {
    return is_type(common::BOOLEAN) || is_type(common::DOUBLE) ||
           is_type(common::TEXT) || is_type(common::INT64) || is_type(common::NULL_TYPE);
  }
...
#endif // STORAGE_TSFILE_READ_COMMON_ROW_RECORD_H
