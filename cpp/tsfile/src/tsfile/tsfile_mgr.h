...
#ifndef STORAGE_TSFILE_TSFILE_MGR_H
#define STORAGE_TSFILE_TSFILE_MGR_H

#include "common/db_common.h"
#include "common/mutex/mutex.h"
#include "tsfile/scan_iterator.h"
...
FORCE_INLINE bool compare_timerange_openfile_pair(const TimeRangeOpenFilePair &x,
                                                  const TimeRangeOpenFilePair &y)
{
...
public:
  ...
  int add_new_file(const common::FileID &file_id,
                   OpenFile *open_file);
...
#endif // STORAGE_TSFILE_TSFILE_MGR_H
