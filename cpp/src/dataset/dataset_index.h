...
static const uint32_t DATASET_INDEX_SECTION_COUNT = 14;
...
static_assert(sizeof(TableRecord) == 48, "TableRecord must be 48 bytes");
...
static_assert(sizeof(TsFileRecord) == 48, "TsFileRecord must be 48 bytes");
static_assert(sizeof(TableFileSpanRecord) == 32,
              "TableFileSpanRecord must be 32 bytes");
static_assert(sizeof(DeviceFileSpanRecord) == 48,
              "DeviceFileSpanRecord must be 48 bytes");
static_assert(sizeof(SeriesFileSpanRecord) == 48,
              "SeriesFileSpanRecord must be 48 bytes");
