...
std::vector<DatasetIndexSectionData> make_minimal_sections() {
    ...
    TableRecord table = {0, 0, 0x1234, 0, 1, 0, 1, 0, 1, 0};
    ...
    TsFileRecord file = {3, 0, 4096, 0, 9, 0x5678, 0};
    TableFileSpanRecord table_span = {0, 0, 0, 9, 10};
    DeviceFileSpanRecord device_span = {0, 0, 0, 0, 0, 0, 0, 9, 10};
    SeriesFileSpanRecord series_span = {0, 0, 0, 0, 0, 9, 9, 10};
    SeriesLocatorRecord locator = {0, 0, 1, 128, 16, 1};
    ...
    sections.push_back(
        fixed_section(DatasetIndexSectionType::TABLE_FILE_SPAN,
                      std::vector<TableFileSpanRecord>(1, table_span)));
    sections.push_back(
