...
import org.apache.tsfile.external.commons.io.RandomAccessFileMode;
import org.apache.tsfile.external.commons.io.RandomAccessFiles;
...
/**
 * Abstracts the origin of data for builders like a {@link File}, {@link Path}, {@link Reader},
 * {@link Writer}, {@link InputStream}, {@link OutputStream}, and {@link URI}.
 *
 * <p>Some methods may throw {@link UnsupportedOperationException} if that method is not implemented
 * in a concrete subclass, see {@link #getFile()} and {@link #getPath()}.
 *
...
public abstract class AbstractOrigin<T, B extends AbstractOrigin<T, B>>
   ...
   * A {@link File} origin.
   *
   * <p>Starting from this origin, you can get a byte array, a file, an input stream, an output
   * stream, a path, a reader, and a writer.
   */
   ...
   *
   * <p>This origin cannot provide some of the other aspects.
   */
   ...
   *
   * <p>This origin cannot provide other aspects.
   */
