...
/**
 * A DoubleTypeService wraps a switch(dataType) clause into a checked service class. Implementations
 ...
 *
 * <p>It returns double only.
 */
public interface DoubleTypeService {

  double call(Type type);
