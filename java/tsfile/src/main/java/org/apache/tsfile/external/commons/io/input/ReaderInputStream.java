 ...
 */
package org.apache.tsfile.external.commons.io.input;
 ...
 *
 * @see org.apache.tsfile.external.commons.io.output.WriterOutputStream
 * @since 2.0
 */
public class ReaderInputStream extends InputStream {
  ...
  public static class Builder extends AbstractStreamBuilder<ReaderInputStream, Builder> {
     ...
     *
     * <p>This builder use the aspects Reader, Charset, CharsetEncoder, buffer size.
     *
     * <p>You must provide an origin that can be converted to a Reader by this builder, otherwise,
     * this call will throw an {@link UnsupportedOperationException}.
     *
    ...
    public ReaderInputStream get() throws IOException {
      return new ReaderInputStream(
          checkOrigin().getReader(getCharset()), charsetEncoder, getBufferSize());
    }
    ...
    public Builder setCharsetEncoder(final CharsetEncoder newEncoder) {
      charsetEncoder =
          CharsetEncoders.toCharsetEncoder(newEncoder, () -> newEncoder(getCharsetDefault()));
   ...
   * default input buffer size of {@value IOUtils#DEFAULT_BUFFER_SIZE} characters.
   *
   ...
   * IOUtils#DEFAULT_BUFFER_SIZE} characters.
   *
