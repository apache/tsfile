 ...
 * {@link UnsupportedOperationException} by providing a more semantically rich description of the
 * problem.
 *
 * <p>{@link NotImplementedException} represents the case where the author has yet to implement the
