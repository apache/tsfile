...
/**
 * A FloatTypeService wraps a switch(dataType) clause into a checked service class. Implementations
 ...
 *
 * <p>It returns float only.
 */
public interface FloatTypeService {

  float call(Type type);
