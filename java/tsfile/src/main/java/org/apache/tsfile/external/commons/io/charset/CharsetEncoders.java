...
package org.apache.tsfile.external.commons.io.charset;
...
public final class CharsetEncoders {
   ...
   * @since 2.13.0
   */
  public static CharsetEncoder toCharsetEncoder(
      final CharsetEncoder charsetEncoder, final Supplier<CharsetEncoder> defaultSupplier) {
