...
public class BinaryOperatorsTest {
  ...
  public void testEq() {
    ...
    Assert.assertFalse(
        eq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
  }
  ...
  public void testNotEq() {
    ...
    Assert.assertTrue(
        notEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
    Assert.assertFalse(
        notEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("a", STRING_CHARSET)));
  }
  ...
  public void testGt() {
    ...
    Assert.assertFalse(
        gt.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("a", STRING_CHARSET)));
  }
  ...
  public void testGtEq() {
    ...
    Assert.assertTrue(
        gtEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("a", STRING_CHARSET)));
    Assert.assertTrue(
        gtEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
    Assert.assertFalse(
        gtEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("c", STRING_CHARSET)));
  }
  ...
  public void testLt() {
    ...
    Assert.assertFalse(
        lt.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
  }
  ...
  public void testLtEq() {
    ...
    Assert.assertTrue(
        ltEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("a", STRING_CHARSET)));
    Assert.assertTrue(
        ltEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
    Assert.assertFalse(
        ltEq.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("c", STRING_CHARSET)));
  }
  ...
  public void testBetweenAnd() {
    Filter between =
        ValueFilterApi.between(
            ...
            TEXT);
    Assert.assertTrue(
        between.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("b", STRING_CHARSET)));
    Assert.assertFalse(
        between.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("d", STRING_CHARSET)));
  }
  ...
  public void testNotBetweenAnd() {
    Filter notBetween =
        ValueFilterApi.notBetween(
            ...
            TEXT);
    Assert.assertTrue(
        notBetween.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("d", STRING_CHARSET)));
    Assert.assertFalse(
  ...
  public void testIn() {
    ...
    Assert.assertFalse(
        in.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("c", STRING_CHARSET)));
  }
  ...
  public void testNotIn() {
    ...
    Assert.assertFalse(
        in.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("a", STRING_CHARSET)));
  }
  ...
  public void testRegexp() {
    ...
    Assert.assertTrue(
        regexp.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("abc", STRING_CHARSET)));
    Assert.assertFalse(
        regexp.satisfyBinary(DEFAULT_TIMESTAMP, new Binary("bcd", STRING_CHARSET)));
  }
